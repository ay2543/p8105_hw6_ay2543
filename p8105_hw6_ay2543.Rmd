...
```
The adjusted odds ratio for solving homicides comparing male victims to female victims holding age and race fixed is **`r baltimore_odds %>% filter(term == "victim_sexMale") %>% pull (OR)` (`r baltimore_odds %>% filter(term == "victim_sexMale") %>% pull (ci.low)`, `r baltimore_odds %>% filter(term == "victim_sexMale") %>% pull (ci.high)`)**.
