...
sum(is.na(bwt))
```
I selected gestational weeks (gaweeks), mother's weight gain during pregnancy (wtgain) and baby’s length at birth (blength) because I expect these to be closely and more directly related to birthweight from a biological standpoint.
