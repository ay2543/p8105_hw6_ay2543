...
pregnancy (wtgain) and baby’s length at birth (blength) because I expect
these to be closely and more directly related to birthweight from a
biological standpoint.

``` r
m1 = lm(bwt ~ gaweeks + wtgain + blength, data = bwt)
m1
```

    ## 
    ## Call:
    ## lm(formula = bwt ~ gaweeks + wtgain + blength, data = bwt)
    ## 
    ## Coefficients:
    ## (Intercept)      gaweeks       wtgain      blength  
    ##   -4248.431       25.624        4.495      125.693
